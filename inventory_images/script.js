...
window.addEventListener("message", function(event) {
    ...
    switch (item.type) {
        case "OPEN_MARKET":
            ...
            $('.shop-logo-resizer img').attr('src','https://raw.githubusercontent.com/Aviradim/Evolve-IMGS/main/inventory_images/'+item.logo+'.png')
                ...
                if (indexInArray == 0) {
                    $('.one-item-area').append(`
                     <div class="vertical-item">
                       <img src="https://raw.githubusercontent.com/Aviradim/Evolve-IMGS/main/inventory_images/${valueOfElement.itemImage}.png">
       ...
       <div class="shop-items-categories">
           <img src="https://raw.githubusercontent.com/Aviradim/Evolve-IMGS/main/inventory_images/${value.itemImage}.png">
           <div class="item-description-normal">
        ...
        $('.card-shop-items').append(`
          <div class="shop-items-card ${buyCategories}-${timeVal}">
              <div class="item-image-card">
                  <img src="https://raw.githubusercontent.com/Aviradim/Evolve-IMGS/main/inventory_images/${buyItemImage}.png">
              </div>
